...
for v in MODEL_DIR PYTHON SERVED_MODEL_NAME HOST PORT MAX_SEQ ARENA_GB \
         ...
         DSV41_PREFILL_ATTN_GEMM DSV41_PREFILL_HC_GEMM DSV41_PREFILL_FP8_DEQUANT DSV41_PREFILL_FUSED_SINKHORN DSV41_PREFILL_UNPACK_CACHE_GB \
         DSV41_PREFILL_TOPK DSV41_PREFILL_FOLD DSV41_EXFOLD_TABLE; do
    if [[ -n "${!v:-}" ]]; then
